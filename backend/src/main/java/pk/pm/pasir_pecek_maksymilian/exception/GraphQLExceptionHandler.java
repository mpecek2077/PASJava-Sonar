...
import org.springframework.lang.NonNull; // Używamy standardowego NonNull ze Springa
...
public class GraphQLExceptionHandler implements DataFetcherExceptionResolver {
    ...
    public @NonNull Mono<List<GraphQLError>> resolveException(
        ...
        // Wyłapujemy błędy walidacji (np. za długi tag, puste pole)
        ...
        // Obsługa wszystkich innych nieznanych błędów
